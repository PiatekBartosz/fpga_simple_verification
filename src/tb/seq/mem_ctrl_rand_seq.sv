class mem_ctrl_rand_seq extends uvm_sequence #(mem_ctrl_seq_item);
    ...
    task body();
        ...
        `uvm_info(get_name(), $sformatf(
                  "=== Random seq start: data_length=%s (%0d write+read pairs) ===",
        ...
        for (int i = 0; i < n; i++) begin
            ...
            if (item.error) begin
                ...
                fail_cnt++;
                               ...
                               i, item.addr, item.wdata), UVM_LOW)
        end
